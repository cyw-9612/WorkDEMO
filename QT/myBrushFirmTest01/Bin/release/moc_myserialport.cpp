...
#include <memory>
#include "../../../myBrushFirmTest02/uart/myserialport.h"
...
QT_INIT_METAOBJECT const QMetaObject MySerialPort::staticMetaObject = { {
    QMetaObject::SuperData::link<CommInterface::staticMetaObject>(),
...
void *MySerialPort::qt_metacast(const char *_clname)
{
    ...
    return CommInterface::qt_metacast(_clname);
}

int MySerialPort::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = CommInterface::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
