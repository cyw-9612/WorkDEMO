/****************************************************************************
** Meta object code from reading C++ file 'comm_interface.h'
**
...
#include <memory>
#include "../../../myBrushFirmTest02/protocol/comm_interface.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'comm_interface.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 6), // "onRecv"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11), // "QByteArray&"
QT_MOC_LITERAL(4, 34, 4), // "data"
QT_MOC_LITERAL(5, 39, 10) // "extra_data"

    },
    "CommInterface\0onRecv\0\0QByteArray&\0"
    "data\0extra_data"
};
...
void CommInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onRecv((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< void*(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CommInterface::*)(QByteArray & , void * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommInterface::onRecv)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CommInterface::onRecv(QByteArray & _t1, void * _t2)
{
