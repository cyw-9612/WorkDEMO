...
const QVector<ProcessInfo> &threadCheck::getVec()
{
    return m_vec;
}

void threadCheck::clearVec()
{
    m_vec.clear();
}

void threadCheck::insertInfo(const QString &pID, const QString &thrNum,
