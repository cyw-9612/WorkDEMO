...
*/
enum Interaction { iRangeDrag         = 0x001 ///< <tt>0x001</tt> 轴范围可拖动 Axis ranges are draggable (see \ref QCPAxisRect::setRangeDrag, \ref QCPAxisRect::setRangeDragAxes)
                   ,iRangeZoom        = 0x002 ///< <tt>0x002</tt> 使用鼠标滚轮可以缩放轴范围 Axis ranges are zoomable with the mouse wheel (see \ref QCPAxisRect::setRangeZoom, \ref QCPAxisRect::setRangeZoomAxes)
                   ,iMultiSelect      = 0x004 ///< <tt>0x004</tt> 用户可以通过按住由设置的修改器来选择多个对象 The user can select multiple objects by holding the modifier set by \ref QCustomPlot::setMultiSelectModifier while clicking
                   ,iSelectPlottables = 0x008 ///< <tt>0x008</tt> 可选择打印表 Plottables are selectable (e.g. graphs, curves, bars,... see QCPAbstractPlottable)
